...
public class PersonEditDialogController {
    ...
    public void setPerson(Person person) {
        ...
        phoneTypeField.setText(person.getPhoneType());
    ...
    private void handleOk() {
        if (isInputValid()) {
            ...
            person.setPhoneType(phoneTypeField.getText());
    ...
    private boolean isInputValid() {
        ...
        if (phoneTypeField.getText() == null || phoneTypeField.getText().length() == 0) {
            errorMessage += "No valid phone number type!\n";
        }

        /*
        * код проверки для интеджер
